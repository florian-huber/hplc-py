...
for a in ax:
    ...
    a.plot(chrom.df['time'], chrom.df[chrom.int_col],
...
ax[0].plot(chrom.df['time'], chrom.unmixed_chromatograms[:, 0],
           color=cor['purple'], lw=0.5)
ax[0].fill_between(
    chrom.df['time'], chrom.unmixed_chromatograms[:, 0], color=cor['pale_purple'], alpha=0.5)

ax[0].plot(chrom.df['time'], chrom.unmixed_chromatograms[:, 1],
           color=cor['green'], lw=0.5, zorder=10001)
ax[0].fill_between(
    chrom.df['time'], chrom.unmixed_chromatograms[:, 1], color=cor['pale_green'], zorder=1000, alpha=0.5)
ax[0].plot(chrom.df['time'], np.sum(chrom.unmixed_chromatograms, axis=1), '--',
...
ax[1].plot(chrom.df['time'], chrom.unmixed_chromatograms[:, 1],
           color=cor['green'], lw=0.5, zorder=10001)
ax[1].fill_between(
    chrom.df['time'], chrom.unmixed_chromatograms[:, 1], color=cor['pale_green'], zorder=1000, alpha=0.5, hatch='....', edgecolor=cor['dark_green'], linewidth=0.5)
ax[1].plot(chrom.df['time'], np.sum(chrom.unmixed_chromatograms, axis=1), '--',
           color=cor['light_red'], lw=0.5, zorder=10001)
ax[1].plot(chrom.df['time'], chrom.unmixed_chromatograms[:, 0],
...
ax[0].plot(test_constrained['known_conc'], test_constrained['concentration'], 'o', ms=8, color=cor['light_green'],
           markeredgecolor=cor['dark_green'])
for g, d in test_loose.groupby('known_conc'):
    ax[1].plot(d['known_conc'], d['concentration'], 'o', ms=8, color=cor['pale_green'],
               markeredgecolor=cor['dark_green'])
    ax[1].plot(d['known_conc'], d['concentration'], '.', ms=4, color=cor['dark_green'],
               markeredgecolor=cor['dark_green'])
